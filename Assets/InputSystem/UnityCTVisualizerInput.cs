...
namespace UnityCTVisualizer
{
    ...
    ""controlSchemes"": []
        ...
        {
            Debug.Assert(!m_VolumetricObjectControls.enabled, "This will cause a leak and performance issues, UnityCTVisualizerInput.VolumetricObjectControls.Disable() has not been called.");
        }
